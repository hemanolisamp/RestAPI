const ApiKey = "c0705ae62b7d41b3861b4c8047edc851";
                ...
                btn.onclick = (event) => {
                    ...
                    fetch(url, fetchHeader)
                        ...
                        .then(resDetail => {
                            ...
                            <br><p>Full Name : ${resDetail.shortName}<br>
                            Founded : ${resDetail.founded} <br>
                            Ground  : ${resDetail.venue} <br>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var modalDetail = M.Modal.init(m);
});